...
type Route struct {
	...
	Destination   float64                `protobuf:"fixed64,3,opt,name=destination,proto3" json:"destination,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Route) GetDestination() float64 {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"q\n" +
	"\x05Route\x12*\n" +
	"\bgeometry\x18\x01 \x03(\v2\x0e.trip.GeometryR\bgeometry\x12\x1a\n" +
	"\bdistance\x18\x02 \x01(\x01R\bdistance\x12 \n" +
	"\vdestination\x18\x03 \x01(\x01R\vdestination\"\x82\x01\n" +
	"\bRideFare\x12\x0e\n" +
